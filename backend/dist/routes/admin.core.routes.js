...
router.get('/notifications', admin_core_controller_1.AdminCoreController.getNotifications);
router.post('/notifications/read-all', admin_core_controller_1.AdminCoreController.markAllNotificationsRead);
router.post('/notifications/:id/read', admin_core_controller_1.AdminCoreController.markNotificationRead);
