      ...
      >
        <Card className="border-border/50 bg-card/80 backdrop-blur-md shadow-2xl relative overflow-hidden">
          ...
          <CardContent className="pt-6">
            <Button onClick={() => window.location.href = authUrl} size="lg" className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white flex items-center justify-center gap-3 h-12 text-lg">
