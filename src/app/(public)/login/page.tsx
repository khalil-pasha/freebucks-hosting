      ...
      >
        <Card className="border-border/50 bg-card/80 backdrop-blur-md shadow-2xl relative overflow-hidden">
          ...
          <CardContent className="pt-6">
            <Button onClick={() => window.location.href = process.env.NODE_ENV === 'production' ? 'https://api.freebucks.host/auth/discord' : (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000') + '/auth/discord'} size="lg" className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white flex items-center justify-center gap-3 h-12 text-lg">
